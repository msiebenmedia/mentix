...
@section('title', 'Fragenkatalog anlegen')
...
<div class="min-h-screen bg-base-200 py-8 px-4">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold">Fragenkatalog anlegen</h1>
                <p class="text-base-content/70 mt-1">
                    Hier kannst du einen neuen Fragenkatalog erstellen.
                </p>
            </div>
        ...
        <div class="card bg-base-100 shadow-xl border border-base-300">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.question-catalogs.store') }}" class="space-y-6">
                    @csrf
