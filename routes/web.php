...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/profil', [ProfileController::class, 'update'])->name('profile.update');
        Route::get('/quizzes/{quiz}/play', [QuizPlayerController::class, 'show'])
        ->name('quizzes.play');

    Route::post('/quizzes/{quiz}/answer', [QuizPlayerController::class, 'submitAnswer'])
        ->name('quizzes.answer');
});
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::put('quizzes/{quiz}/questions', [QuizController::class, 'updateQuestions'])->name('quizzes.questions.update');
        ...
        Route::get('quizzes/{quiz}/host', [QuizHostController::class, 'show'])
            ->name('quizzes.host');

        Route::post('quizzes/{quiz}/start', [QuizHostController::class, 'start'])
            ->name('quizzes.start');

        Route::post('quizzes/{quiz}/pause', [QuizHostController::class, 'pause'])
            ->name('quizzes.pause');

        Route::post('quizzes/{quiz}/next-question', [QuizHostController::class, 'nextQuestion'])
            ->name('quizzes.next-question');

        Route::post('quizzes/{quiz}/previous-question', [QuizHostController::class, 'previousQuestion'])
            ->name('quizzes.previous-question');

        Route::post('quizzes/{quiz}/reveal-question', [QuizHostController::class, 'revealQuestion'])
            ->name('quizzes.reveal-question');

        Route::post('quizzes/{quiz}/finish', [QuizHostController::class, 'finish'])
            ->name('quizzes.finish');
            Route::post('/quizzes/{quiz}/restart', [QuizController::class, 'restart'])
    ->name('quizzes.restart');
});
